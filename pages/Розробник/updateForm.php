        ...
        <div class="mainbox">
            <div class="content">    
                <form action="update.php" method="post">
                        <p>Пошук</p><br>
                        <label>Назва студії</label><input name="name1" type="text"><br>
                        <p>Дані для вставки</p><br>
                        <label>Назва студії</label><input name="name2" type="text"><br>
                        <label>Досвід</label><input name="dsd" type="text"><br>
